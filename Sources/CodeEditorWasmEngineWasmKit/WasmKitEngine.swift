...
final class WasmKitInstance: CodeEditorWasmInstance, @unchecked Sendable {
    ...
    func interrupt() {
        state.withLock { $0.interrupted = true; $0.meters.interrupted = true }
    }
...
private extension WasmValue {
    func toWasmKitValue() -> Value {
        switch self {
    ...
    static func fromWasmKit(_ v: Value) -> WasmValue {
        switch v {
